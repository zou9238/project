...
export const BookModal = (props) => {
    ...
    const [selectDBSource_author, setSelectDBSource_author] = React.useState(null);
    ...
    async function updateAuthorsOption(){
        let resJson = await getAuthors();
        resJson.forEach(element => {
            console.log(element);
        });
        console.log(resJson);
        ...
        setSelectDBSource_author(AuthorsOption);
    }
            ...
            >
                ...
                <Modal.Body style={{ backgroundColor: '#DED0B6'}}>
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <br />
                        {generateFormComps(selectDBSource_author)}
                        <br />
